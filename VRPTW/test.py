...
def args2dict(args):
    ...
    model_params = {"embedding_dim": args.embedding_dim, "sqrt_embedding_dim": args.sqrt_embedding_dim,
                    ...
                    "norm": args.norm, "norm_loc": args.norm_loc, "problem": None}
...
if __name__ == "__main__":
    ...
    # env_params
    parser.add_argument('--problem', type=str, default="VRPTW")
    ...
    # model_params
    parser.add_argument('--model_type', type=str, default="DAR-POMO")
    ...
    parser.add_argument('--norm_loc', type=str, default="norm_last", choices=["norm_last", "norm_last"])
    ...
    parser.add_argument('--aug_factor', type=int, default=1, choices=[1, 8], help="whether to use instance augmentation during evaluation")
